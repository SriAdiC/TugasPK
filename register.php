        ...
        <div class="outter-form-login">
            ...
            <form action="send_register.php" class="inner-login" method="post">
                ...
                <div class="form-group">
                    <input type="text" class="form-control" name="nickname" placeholder="Nama" required>
                </div>
                ...
                <!--  <div class="form-check  form-check-inline">
                    <input class="form-check-input" type="checkbox" name="level" id="Admin" value="admin">
                    <label class="form-check-label" for="Admin">Admin</label>
                </div>
                <div class="form-check  form-check-inline">
                    <input class="form-check-input" type="checkbox" name="level" id="Member" value="member">
